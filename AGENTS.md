...
This project is indexed by GitNexus as **webSerialCommunication** (8489 symbols, 16097 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
