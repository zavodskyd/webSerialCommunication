...
This project is indexed by GitNexus as **webSerialCommunication** (1895 symbols, 3868 relationships, 146 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
