...
This project is indexed by GitNexus as **webSerialCommunication** (2046 symbols, 4431 relationships, 155 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
