...
This project is indexed by GitNexus as **webSerialCommunication** (6761 symbols, 12363 relationships, 228 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
