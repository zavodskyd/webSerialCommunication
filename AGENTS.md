...
This project is indexed by GitNexus as **webSerialCommunication** (7879 symbols, 14780 relationships, 290 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
