...
This project is indexed by GitNexus as **webSerialCommunication** (6558 symbols, 12067 relationships, 227 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
