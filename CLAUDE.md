...
This project is indexed by GitNexus as **webSerialCommunication** (8052 symbols, 15168 relationships, 295 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
