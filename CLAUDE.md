...
This project is indexed by GitNexus as **webSerialCommunication** (1932 symbols, 4033 relationships, 149 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
