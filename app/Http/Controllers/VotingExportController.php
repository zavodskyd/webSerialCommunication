...
class VotingExportController extends Controller
{
    ...
    public function resultsPdf(Voting $voting, NativePdfExporter $exporter): JsonResponse
    {
        return $this->exportPdf(
            ...
            data: $this->resultsViewData($voting, exportPdfUrl: null, showPrintToolbar: false, showPrintScript: false),
    ...
    public function pressedOptionsPdf(Voting $voting, NativePdfExporter $exporter): JsonResponse
    {
        return $this->exportPdf(
            ...
            data: $this->pressedOptionsViewData($voting, exportPdfUrl: null, showPrintToolbar: false, showPrintScript: false),
            filename: $this->pressedOptionsFilename($voting),
        );
    }

    /**
     * @return array{voting: Voting, questions: Collection<int, VotingQuestion>, exportPdfUrl: ?string, showPrintToolbar: bool, showPrintScript: bool}
     */
